...
class Purchase extends CI_Controller
{
    ...
    public function getPurchaseReturnDetails(){
        ...
        $returnDetails = $this->db->query("
            ...
            join tbl_brand b on b.brand_SiNo = p.Product_SlNo
    ...
    public function damage_product_list()
    {
        ...
        $data['brands'] = $this->db->query("select * from tbl_brand  where status = 'a'")->result();
