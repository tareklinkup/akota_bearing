...
<div class="row" id="customerDueList">
	...
	<div class="col-md-12" style="display: none" v-bind:style="{display: dues.length > 0 ? '' : 'none'}">
		...
		<a href="javascript:" 
			onclick="exportToExcel('customer-due', 'Customer Due - <?php echo date('D d F, Y') ?>')"
		> 
			<i class="fa fa-file-excel-o"></i> Customer Due Excel 
		</a> | &nbsp;

		<a href="javascript:" 
			onclick="exportToWord('Customer Due - <?php echo date('D d F, Y') ?>')"
		> 
			<i class="fa fa-file-word-o"></i> Customer Due Word 
		</a>

		<div class="table-responsive googoose-wrapper" id="reportTable">
			<table class="table table-bordered" id="customer-due">
				<thead>
					<tr>
						<th>Customer Id</th>
						<th>Customer Name</th>
