...
<div id="supplierDue">
	...
	<div class="row" style="display:none;" v-bind:style="{display: dueList.length > 0 ? '' : 'none'}">
		<div class="col-md-12">
			...
			<a href="javascript:" 
				onclick="exportToExcel('supplier-due', 'Supplier Due - <?php echo date('D d F, Y') ?>')"
			> 
				<i class="fa fa-file-excel-o"></i> Supplier Due Excel 
			</a> | &nbsp;
			<a href="javascript:" 
				onclick="exportToWord('Supplier Due - <?php echo date('D d F, Y') ?>')"
			> 
				<i class="fa fa-file-word-o"></i> Supplier Due Word 
			</a>

			<div class="table-responsive googoose-wrapper" id="reportTable">
				<table class="table table-bordered" id="supplier-due">
					<thead>
						<tr>
							<th>Supplier Code</th>
							<th>Supplier Name</th>
