...
<div class="row" id="productLedger">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		...
		<div class="form-group">
				<label class="col-sm-1 control-label no-padding-right"> Brand </label>
				<div class="col-sm-1">
					<v-select v-bind:options="brands" v-model="selectedBrand" v-on:input="onChangeBrand" label="brand_name"></v-select>
				</div>
			</div>
			<div class="form-group">
...
<script>
	...
	new Vue({
		...
		methods:{
			async getProducts(){
				await  axios.get('/get_products').then(res => {
