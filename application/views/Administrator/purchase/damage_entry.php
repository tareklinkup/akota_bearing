        ...
        <div class="col-md-12">
            <form class="form-horizontal" @submit.prevent="addDamage">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
						<v-select v-bind:options="brands" label="brand_name" v-on:input="onChangeBrand" v-model="selectedBrand" placeholder="Select Brand"></v-select>
                    </div>
				</div>
        ...
        data(){
            return {
				...
				columns: [
                    ...
                    { label: 'Brand Name', field: 'brand_name', align: 'center' },
...
await  axios.post('/get_brand_wise_product',{brand_sl_no:this.selectedBrand.brand_SiNo}).then(res => {
    this.products = res.data;
            ...
            editDamage(damage){
                ...
                this.selectedBrand = {
                    brand_name:damage.brand_name,
                    brand_SiNo:damage.brand_SiNo
                }
            },
