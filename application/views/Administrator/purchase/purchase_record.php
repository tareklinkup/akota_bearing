	...
	<div class="row" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				...
				<div class="form-group" v-bind:style="{display: searchType == '' || searchType == 'user'  || searchType == 'supplier' ? '' : 'none'}">
	...
	<div class="row" style="margin-top:15px;display:none;" v-bind:style="{display: purchases.length > 0 ? '' : 'none'}">
		...
		<div class="col-md-12">
			<div class="table-responsive" id="reportContent">
				<table 
					class="record-table" 
					v-if="(searchType == '' || searchType == 'user' || searchType == 'supplier') && recordType == 'with_details'" 
					style="display:none" 
					v-bind:style="{display: (searchType == '' || searchType == 'user' || searchType == 'supplier') && recordType == 'with_details' ? '' : 'none'}"
					>
					<thead>
						<tr>
							<th>Invoice No.</th>
					...
					<tbody>
						<template v-for="purchase in purchases">
							<tr>
								...
								<td>{{ purchase.purchaseDetails[0].brand_name }}</td>
								<td>{{ purchase.purchaseDetails[0].origin }}</td>
