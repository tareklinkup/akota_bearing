...
<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group" style="margin-top:10px;">
			...
			<div class="col-sm-2">
				<select class="chosen-select form-control" name="brand_id" id="brand_id" data-placeholder="Choose a brand...">
					<option value="">  </option>
					<?php foreach($brands as $brand){ ?>
					<option value="<?php echo $brand->brand_SiNo; ?>"><?php echo $brand->brand_name; ?></option>
					<?php } ?>
				</select>
			</div>
		</div>
...
<script type="text/javascript">
    function searchforRecord(){
        ...
        var inputdata = 'prod_id='+prod_id+'&brandId='+ brandId;
