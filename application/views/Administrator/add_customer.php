		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<v-select v-bind:options="parents" v-model="selectedParent" label="display_name"></v-select>
					</div>
				</div>
	...
	new Vue({
		...
		methods: {
			...
			saveCustomer(){
				...
				this.customer.parent_id = this.selectedParent != null ? this.selectedParent.Customer_SlNo: null; 
			...
			editCustomer(customer){
				...
				this.selectedParent = this.parents.find(item => item.Customer_SlNo == customer.parent_id)
