                        ...
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" v-bind:style="{display: brands.length > 0 ? 'none' : ''}"></select>
                                            <v-select id="brand" v-bind:options="brands" v-model="selectedBrand" label="brand_name" v-on:input="onChangeBrand" v-bind:style="{display: brands.length > 0 ? '' : 'none'}"></v-select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <input type="number" class="form-control" v-model="quantity" ref="quantity" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<script>
    ...
    new Vue({
        ...
        methods: {
            ...
            async getBrands(){
                  await axios.get('/get_brands').then(res=>{
            ...
            getBranches() {
                axios.get('/get_branches').then(res => {
                    ...
                    this.branches = res.data.filter(item => item.status == 'a');
                })
            },
            async onChangeBrand(){
                await axios.post('/get_brand_wise_product',{brand_sl_no:this.selectedBrand.brand_SiNo}).then(res=>{
            ...
            addToCart(){
                ...
                let cartProduct = {
                    ...
                    category: this.selectedProduct.ProductCategory_Name,
            ...
            async getTransfer() {
                ...
                this.cart = transferDetails.map(td => {
                    let product = {
                        ...
                        category: td.ProductCategory_Name,
                        brand: td.brand_name,
                        origin: td.origin,
