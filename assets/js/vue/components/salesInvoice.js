        ...
        <div>
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="javascript:" 
                        onclick="exportToWord('Sale Invoice')"
                    > 
                        <i class="fa fa-file-word-o"></i> Sales Invoice Word 
                    </a>
                </div>
            </div>
            <div id="invoiceContent" class="googoose-wrapper">
                <div class='googoose cover' style="text-align: center">
                    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        ...
                        <strong></strong>  {{ sales.pr_po_label }} <br>
                        <strong>Challan  No :</strong>  {{ sales.pr_po_text }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
        ...
        async print(){
            ...
            if (this.currentBranch.print_type == '3') {
                    ...
                    <html>
                        ...
                        <body>
                            <div style="text-align:center;">
                                <img src="/uploads/branch_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:80px;margin:0px;" /><br>
                ...
                printWindow.document.write(`
                    ...
                    <body>
                        <div class="row">
                            <div class="col-xs-2"><img src="/uploads/branch_thum/${this.currentBranch.Company_Logo_thum}" alt="Logo" style="height:80px;" /></div>
